...
class UserController extends SecureController{
	...
	function add($formdata = null){
		if($formdata){
			...
			$request = $this->request;
			//fillable fields
			$fields = $this->fields = array("Username","Nama","Tempat_Tgl_Lahir","Jabatan","email","Password","Foto","user_role_id");
	...
	function edit($rec_id = null, $formdata = null){
		...
		$tablename = $this->tablename;
		 //editable fields
		$fields = $this->fields = array("id_user","Username","Nama","Tempat_Tgl_Lahir","Jabatan","Foto");
		if($formdata){
			$postdata = $this->format_request_data($formdata);
			$this->rules_array = array(
				'Username' => 'required',
