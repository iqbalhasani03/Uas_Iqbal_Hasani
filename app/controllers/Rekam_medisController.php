...
class Rekam_medisController extends SecureController{
	...
	function index($fieldname = null , $fieldvalue = null){
		...
		if(!empty($request->search)){
			...
			$search_condition = "(
				...
				rekam_medis.Tgl_Periksa LIKE ? OR 
	...
	function add($formdata = null){
		if($formdata){
			...
			$request = $this->request;
			//fillable fields
			$fields = $this->fields = array("Tgl_Periksa","Nama_Pasien","Keluhan","Dokter","Diagnosa","Obat","Ruangan");
	...
	function edit($rec_id = null, $formdata = null){
		...
		$tablename = $this->tablename;
		 //editable fields
		$fields = $this->fields = array("id_Medis","Tgl_Periksa","Nama_Pasien","Keluhan","Dokter","Diagnosa","Obat","Ruangan");
		if($formdata){
			$postdata = $this->format_request_data($formdata);
			$this->rules_array = array(
				'Tgl_Periksa' => 'required',
