                                    ...
                                    <table class="table  table-striped table-sm text-left">
                                        <thead class="table-header bg-light">
                                            <tr>
                                                ...
                                                <?php } ?>
                                                <th class="td-sno">#</th>
                                                <th  class="td-id_Pasien"><i class="fa fa-user "></i> Id Pasien</th>
                                                <th  class="td-Nama_Pasien"><i class="fa fa-user "></i> Nama Pasien</th>
                                                <th  class="td-JK"><i class="fa fa-user-plus "></i> Jk</th>
                                                <th  class="td-nomor_hp"><i class="fa fa-phone-square "></i> Nomor Hp</th>
                                                <th  class="td-Alamat"><i class="fa fa-home "></i> Alamat</th>
                                                <th  class="td-foto"><i class="fa fa-camera "></i> Foto</th>
                                                <th class="td-btn"></th>
                                            </tr>
                                        </thead>
                                        <?php
