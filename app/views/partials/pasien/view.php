                            ...
                            <table class="table table-hover table-borderless table-striped">
                                ...
                                <tbody class="page-data" id="page-data-<?php echo $page_element_id; ?>">
                                    <tr  class="td-id_Pasien">
                                        <th class="title"><i class="fa fa-user "></i> Id Pasien: </th>
                                    ...
                                    <tr  class="td-JK">
                                        <th class="title"><i class="fa fa-user-plus "></i> Jk: </th>
                                        <td class="value">
                                    ...
                                    <tr  class="td-nomor_hp">
                                        <th class="title"><i class="fa fa-phone-square "></i> Nomor Hp: </th>
                                        <td class="value">
                                    ...
                                    <tr  class="td-Alamat">
                                        <th class="title"><i class="fa fa-home "></i> Alamat: </th>
                                        <td class="value">
                                    ...
                                    <tr  class="td-foto">
                                        <th class="title"><i class="fa fa-camera "></i> Foto: </th>
