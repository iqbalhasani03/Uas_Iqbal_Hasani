                                    ...
                                    <div class="form-group ">
                                        ...
                                        <div class="form-group ">
                                            <div class="row">
                                                ...
                                                <div class="col-sm-8">
                                                    <div class="">
                                                        <input id="ctrl-Tempat_Tgl_Lahir"  value="<?php  echo $data['Tempat_Tgl_Lahir']; ?>" type="text" placeholder="Enter Tempat Tgl Lahir"  required="" name="Tempat_Tgl_Lahir"  class="form-control " />
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
