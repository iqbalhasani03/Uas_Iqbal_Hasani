                                    ...
                                    <table class="table  table-striped table-sm text-left">
                                        <thead class="table-header bg-light">
                                            <tr>
                                                ...
                                                <?php } ?>
                                                <th class="td-sno">#</th>
                                                <th  class="td-Tgl_Periksa"><i class="fa fa-calendar "></i> Tgl Periksa</th>
                                                <th  class="td-Nama_Pasien"><i class="fa fa-user "></i> Nama Pasien</th>
                                                <th  class="td-Keluhan"><i class="fa fa-ban "></i> Keluhan</th>
                                                <th  class="td-Dokter"><i class="fa fa-user-md "></i> Dokter</th>
                                                <th  class="td-Diagnosa"><i class="fa fa-building "></i> Diagnosa</th>
                                                <th  class="td-Obat"><i class="fa fa-adjust "></i> Obat</th>
                                                <th  class="td-Ruangan"><i class="fa fa-hospital-o "></i> Ruangan</th>
                                                <th class="td-btn"></th>
                                            </tr>
                                        </thead>
                                        <?php
