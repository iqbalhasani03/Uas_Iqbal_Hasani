                                    ...
                                    <table class="table  table-striped table-sm text-left">
                                        <thead class="table-header bg-light">
                                            <tr>
                                                ...
                                                <?php } ?>
                                                <th class="td-sno">#</th>
                                                <th  class="td-Username"><i class="fa fa-user "></i> Username</th>
                                                <th  class="td-Nama"> Nama</th>
                                                <th  class="td-Tempat_Tgl_Lahir"><i class="fa fa-calendar "></i> Tempat Tgl Lahir</th>
                                                <th  class="td-email"> Email</th>
                                                <th  class="td-Foto"> Foto</th>
                                                <th  class="td-user_role_id"><i class="fa fa-bar-chart "></i> User Role Id</th>
                                                <th class="td-btn"></th>
                                            </tr>
                                        </thead>
                                        <?php
