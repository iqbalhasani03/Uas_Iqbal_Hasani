                        ...
                        <div id="page-report-body" class="">
                            <table class="table table-hover table-borderless table-striped">
                                ...
                                <tbody class="page-data" id="page-data-<?php echo $page_element_id; ?>">
                                    <tr  class="td-id_Obat">
                                        <th class="title"><i class="fa fa-adjust "></i> Id Obat: </th>
                                        <td class="value"> <?php echo $data['id_Obat']; ?></td>
                                    </tr>
                                    <tr  class="td-Nama_Obat">
                                        <th class="title"><i class="fa fa-arrow-circle-down "></i> Nama Obat: </th>
                                        <td class="value">
                                    ...
                                    <tr  class="td-Keterangan">
                                        <th class="title"><i class="fa fa-archive "></i> Keterangan: </th>
                                        <td class="value">
